...
echo ""
echo "  Skills auto-installed (9): gogcli (Google), summarize, ddg-search, pdf-text-extractor,"
echo "    openai-whisper-api, openai-image-gen, weather, healthcheck, skill-creator"
echo "  NOTE: gogcli binary is auto-downloaded by entrypoint.sh from github.com/steipete/gogcli"
echo "        Google OAuth must be set up separately (see architecture docs)"
